    ...
    <section>
      ...
      <section>
        ...
        <p>
          ...
          Comprei esse computador quando comecei a <Link href="/clt-pj-e-o-trabalho-remoto" target="_blank">trabalhar remotamente</Link>.
          </p>
        <p>
        ...
        <p>
          Costumo usar muito um site chamado <Link href="https://witeboard.com/" target="_blank">Witeboard</Link> pra isso e desenhar com mouse nem sempre é tão fácil.
        </p>
        <p>
        ...
        <p>
          Com isso, o <Link href="https://www.samsung.com/br/tablets/galaxy-tab-s/galaxy-tab-s6-lite-10-4-inch-gray-64gb-wi-fi-sm-p615nzavzto/" target="_blank">Tab S6 Lite</Link> da Samsung acabou sendo uma alternativa viável para o que eu buscava. Ele já vem completamente pronto pra uso, com capa, caneta (passiva) e, além de tudo, tem um design muito bonito quando você deixa tudo junto no case!
        </p>
        ...
        <p>
          Pensei em comprar um curvo durante um tempo (e não excluo essa ideia pra um futuro) mas pela diferença de preço e por não saber como iria me adaptar, optei por usar um da LG sem ser curvo. No fim, acabei optando por um de 34", modelo LG <Link href="https://www.lg.com/br/monitores/lg-34WK650-W" target="_blank">34WK650-W</Link>. Ele não é 4k, não tem uma taxa absurda de atualização então está longe de ser um monitor gamer mas, para o que eu preciso, estava ótimo. Como não jogo no computador, me preocupei mais com o fato de ser um UltraWide de uma marca que me passasse confiança, com estética e visual que me agradasse em geral.
        </p>
        ...
        <p>
          Até que eu conheci o <em>switch</em> Kailh Box White e o teclado <Link href="https://www.annepro.net/products/anne-pro-2" target="_blank">Anne Pro 2</Link>. Foi o único <em>switch</em> que eu realmente senti interessante de digitar.
        </p>
        <p>
        ...
        <p>
          Depois de dar chance pra outros produtos, me rendi e comprei o <Link href="https://www.apple.com/br/shop/product/MLA02BE/A/magic-mouse-2-prateado" target="_blank">Magic Mouse</Link> mesmo, não teve jeito.
        </p>
        <p>
          Enquanto escrevia, percebi que o modelo que eu uso (<Link href="https://produto.mercadolivre.com.br/MLB-1409171427-magic-mouse-2-space-gray-mac-macbook-sem-fio-original-_JM" target="_blank">cinza espacial</Link>) foi descontinuado! Uma pena, acho esses produtos no modelo cinza bem mais bonitos...
        </p>
        <p>
          Fora isso, comprei uma <Link href="https://produto.mercadolivre.com.br/MLB-833372525-capa-pelicula-protetora-skin-silicone-apple-magic-mouse-1-2-_JM" target="_blank">película protetora no Mercado Livre</Link> também na cor preta pra ajudar a preservar o mouse, como sou bem calorento e às vezes minhas mãos ficam suadas enquanto trabalho.
        </p>

        <h4>Webcam</h4>
        <p>
          Sempre ouvi falar (e depois de um tempo virei fã) dos produtos da Logitech. Atualmente utilizo uma webcam HD (720p) dessa marca, modelo <Link href="https://www.logitech.com/pt-br/products/webcams/c270-hd-webcam.960-000694.html" target="_blank">C270i</Link>. Olhando pelo site da Logitech, visualmente ela é igual à <Link href="https://www.logitech.com/pt-br/products/webcams/c505-hd-webcam.960-001363.html" target="_blank">C505</Link> ao invés do modelo C270, não sei se aconteceu alguma atualização ou mudança no modelo mas elas são praticamente similares.
        </p>
        <p>
          Ela possui microfone e funciona super bem! Gosto bastante. Futuramente talvez troque para uma do modelo <Link href="https://www.logitech.com/pt-br/products/webcams/brio-4k-hdr-webcam.960-001105.html" target="_blank">Brio</Link> mas é algo que ainda preciso pensar, já que pro meu uso essa atual já é o suficiente.
        </p>
        <p>
          Fora isso, aquele <Link href="https://produto.mercadolivre.com.br/MLB-1525377355-protetor-tampa-camera-webcam-notebook-tablet-c-3-unid-_JM" target="_blank">protetor</Link> é sempre interessante de usar também (já me salvou de passar algumas vergonhas na internet por aí, rs).
        </p>
        ...
        <p>
          Embora eu ache a ideia daqueles headphones com cancelamento de ruído ativo MUITO interessantes (como o da Sony <Link href="https://www.sony.com/et/electronics/headband-headphones/wh-1000xm4" target="_blank">WH-1000XM4</Link>), há uns anos atrás eu comprei um da Edifier modelo <Link href="https://edifier.com.br/headphone-bluetooth-w830bt-edifier-preto.html" target="_blank">W830BT</Link> e tem uma coisa nele que é imbatível: sua bateria.
        </p>
        <p>
        ...
        <p>
          Durante um tempo dei uma força pro <Link href="https://willianjusten.com.br/" target="_blank">Willian Justen</Link> no seu último curso <Link href="https://reactavancado.com.br/" target="_blank">React Avançado</Link> com alguns componentes, conversa vai e conversa vem e ele estava com o microfone parado lá e eu estava cogitando comprar um. Só juntamos esses dois pontos!
          </p>
        <p>
          Acabei ficando com o <Link href="https://www.bluemic.com/en-us/products/yeti/" target="_blank">Blue Yeti (blackout)</Link> que estava parado lá com ele.
        </p>
        ...
        <p>
          Comprei recentemente a cadeira <Link href="https://www.flexform.com.br/loja/office-chairs/cadeira-de-escritorio-flexform-tecton-coffee-unique" target="_blank">Tecton Unique</Link> (modelo coffee, esse  marrom) e foi uma ótima escolha! Tive alguns problemas (eu disse que tinha azar) mas depois de um tempo o contato com a assistência funcionou, resolveram e eu tô bem satisfeito com o produto!
        </p>
        <p>
        ...
        <h4>Apoios</h4>
        <p>
          Pra apoio na região do mouse, eu uso o <Link href="https://deltahub.io/products/carpio-2" target="_blank">Carpio</Link> da DeltaHub. Meu modelo é a versão 1.0, a versão mais nova (atualmente a 2.0) parece mais interessante e tem a cor preta, não só cinza e branco.
        </p>
        <p>
          Na região do teclado, comprei um apoio de um rapaz que vendia no <Link href="https://produto.mercadolivre.com.br/MLB-1508958883-apoio-para-teclado-mecnico-em-madeira-_JM" target="_blank">Mercado Livre</Link> que já fazia no tamanho certo. Só comentei o modelo do meu teclado que ele já tinha as medidas.
        </p>
        <p>
          E, por último mas não menos importante, um apoio de pé. Também comprei um basico no <Link href="https://produto.mercadolivre.com.br/MLB-1069302929-apoio-ergonmico-para-pes-mdf-tabaco-ajustavel-souza-3703-_JM?quantity=1" target="_blank">Mercado Livre</Link> que resolveu super bem algumas dores que eu tinha no joelho ao fim do dia.
        </p>

        <h4>Deskpad</h4>
        <p>
          Taí uma das coisas que, embora sejam
        </p>
        <p>
        ...
        <p>
          Sempre gostei muito de uma marca chamada Cutterman e foi lá que eu encontrei o que mais me agradou. O <Link href="https://www.cutterman.co/produto/desk-pad-coffee-569" target="_blank">deskpad de couro marrom</Link> é o que eu uso, é bem firme e resistente.
        </p>
        ...
        <p>
          A dock da Dell modelo <Link href="https://www.dell.com/ae/business/p/dell-wd19tb-dock/pd" target="_blank">WD19TB</Link> era o melhor pra máquina que eu tenho, com as portas thunderbolts e com várias entradas pra tudo que eu precisava. Pelo que vi, acho que ela foi substituída por um modelo mais novo também.
        </p>
        <p>
        ...
        <p>
          Além disso, também peguei o <Link href="https://www.dell.com/pt-br/shop/kit-de-montagem-da-dell-dock-station/apd/575-bbiv?ref=frommyaccount" target="_blank">kit de montagem</Link> pra poder parafusar ela embaixo da mesa, mas isso já entra no próximo ponto que eu queria comentar...
        </p>
        ...
        <p>
          Pra chegar nesse resultado, eu comprei duas <Link href="https://produto.mercadolivre.com.br/MLB-1284746394-cesto-gaveta-aramado-prateleira-organizador-preto-_JM" target="_blank">cestinhas de arame</Link> que podem ser usadas em alguns armários e "entortei" a haste delas pra frente pra que ficassem retas. Depois disso, só comprei uns <Link href="https://www.leroymerlin.com.br/parafuso-gancho-aco-bicromatizado-1,9x21mm-5-pecas_86947196" target="_blank">parafusos de gancho</Link> e prendi elas embaixo da mesa.
        </p>
        <p>
        ...
        <p>
          Pra finalizar e evitar que eu precise ficar ligando qualquer coisa embaixo da mesa toda vez que preciso carregar (como mouse, teclado), eu deixo um <Link href="https://produto.mercadolivre.com.br/MLB-1527247015-hub-usb-20-de-4-portas-ctomada-480mbps-500gb-sm-_JM" target="_blank">Hub USB</Link> só na mesa. fora isso, o único fo que tem visível é o do microfone. Os do monitor e da webcam ficam presos numa "presilha" que o próprio monitor tem pra organização de cabos de forma que não fique aparente. Eu aproveito essa presilha pra deixar os cabos dos carregadores de celular e tablet ali também. Assim quando preciso, eu só pego atrás do monitor, já que tudo fica ligado em uma das cestinhas (aquela do filtro de linha).
        </p>
        <p>
      ...
      <section>
        <h2>Software</h2>
        <p>
          Muitas das ferramentas que eu uso você consegue dar uma olhada lá nos meus <Link href="https://github.com/gabrieluizramos/dotfiles" target="_blank">dotfiles</Link> (inclusive, <Link href="/configure-seus-dotfiles" target="_blank">já comentamos por aqui</Link> sobre os motivos pelos quais é interessante você criar os seus também)!
        </p>
        <p>
        ...
        <h3>Navegadores</h3>
        <p>
          Utilizo o <Link href="https://www.google.com/intl/pt-BR/chrome/" target="_blank">Chrome</Link>, padrãozão pra grande maioria das coisas. É simples, já estou acostumado e tem algumas facilidades (como enviar páginas para outros dispositivos) que ajuda muito no dia-a-dia sem precisar de alguma extensão.
        </p>
        <p>
        ...
        <p>
          Fora isso, uso o <Link href="https://brave.com/" target="_blank">Brave</Link> de vez em quando, especialmente pros sites de notícia que insistem em colocar um paywall que impede que você consuma conteúdo. Funcionou melhor do que qualquer extensão de AdBlock que eu tentei.
        </p>

        <h3>Notas</h3>
        <p>
          Agora é aquela hora que eu falo: eu sempre fui adepto ao <Link href="https://www.notion.so/" target="_blank">Notion</Link> antes mesmo de ser modinha!
        </p>
        <p>
        ...
        <h3>Editor e tema</h3>
        <p>
          Aqui não tem muito o que inventar também. Já faz uns bons anos que uso <Link href="https://code.visualstudio.com/" target="_blank">Visual Studio Code</Link>.
        </p>
        <p>
          Gosto muito do tema <Link href="https://www.nordtheme.com/" target="_blank">Nord</Link>, ele possui cores bem "emaecidas" e nada muito colorido ou cheio de contraste (além da linha visual "nórdica", rs). Uma curiosidade é que, até os trechos de código que você encontra por aqui no site, também seguem esse tema! Lembro que na época até abri um PR no plugin de temas pra adicionar esse visual.
        </p>
        <p>
          Pra requisições, usei o Insomnia durante um tempo mas voltei pro bom e velho <Link href="https://www.postman.com/" target="_blank">Postman</Link>. As facilidades de deixar os workspaces salvos em nuvem e sincronizados sem precisar pagar são muito boas, embora a interface e a usabilidade do Insomnia em geral seja bem melhor.
        </p>

        <h3>Terminal</h3>
        <p>
          Também bem comum em usuários de MacOS, uso <Link href="https://iterm2.com/" target="_blank">iTerm2</Link> com <Link target="_blank">oh-my-zsh</Link> no tema padrão "af-magic" que já vem pronto pra usar. Mais uma curiosidade é que, a <Link href="/" target="_blank">home do site</Link> é exatamente a visualização do meu terminal!
        </p>
        ...
        <p>
          Foi aí então que eu conheci e adotei o <Link href="https://1password.com/" target="_blank">1Password</Link>, um ótimo gerenciador de senhas, com várias funcionalidades interessantes e os aplicativos em todas as plataformas funcionam que é uma maravilha!
        </p>
        <p>
        ...
        <p>
          Ouvi falar muito bem de um app para gerenciamento de janelas chamado Spectacle, mas por algum motivo que não me lembro ao certo, optei pelo <Link href="https://rectangleapp.com/" target="_blank">Rectangle</Link> e não vivo mais sem.
        </p>
        <p>
        ...
        <h3>Wallpapers</h3>
        <p>
          Provaelmente você sabe que eu adoro fotografia e é um dos <em>hobbies</em> que eu tenho com carinho. Gosto bastante do <Link href="https://unsplash.com/@gabrieluizramos" target="_blank">Unsplash</Link> e nada mais justo do que usar o <Link href="https://apps.apple.com/us/app/unsplash-wallpapers/id1284863847?mt=12" target="_blank">app oficial de wallpaper</Link> deles né?
        </p>
        <p>
        ...
        <h3>Fotografia</h3>
        <p>
          Já que estamos falando de fotografia, outro app que eu não vivo sem é o <Link href="https://www.adobe.com/br/products/photoshop-lightroom.html" target="_blank">Lightroom</Link> para fazer edições das minhas fotos.
        </p>
        <p>
