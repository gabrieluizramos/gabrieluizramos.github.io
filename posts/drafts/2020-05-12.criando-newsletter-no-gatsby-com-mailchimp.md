...
Se quiser ver com mais detalhes como eu implementei esse formulário, você pode conferir diretamente no componente que criei de `Newsletter` que está no [github](https://github.com/gabrieluizramos/blog/blob/master/src/templates/post/article/newsletter/index.js).

---

### Finalizamos o desenvolvimento da Newsletter!
